...
<head>
    ...
    @if (Auth::user()->role == 1)
        <title>Tambangin | Dashboard - Super Admin</title>
    @elseif (Auth::user()->role == 2)
        <title>Tambangin | Dashboard - Admin</title>
    @elseif (Auth::user()->role == 3)
        <title>Tambangin | Dashboard - Pool</title>
    @elseif (Auth::user()->role == 4)
        <title>Tambangin | Dashboard - Kepala Kantor</title>
    @endif
