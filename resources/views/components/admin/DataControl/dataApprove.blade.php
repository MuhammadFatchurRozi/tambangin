...
@section('content')
                                ...
                                @forelse ($getData as $ac)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                        <td>
                                            <form action="{{ route('admin.data-approve.selesai', $ac->id) }}"
                                                method="POST">
                                                @csrf
                                                <button type="submit"
    ...
    <!-- Modal Add -->
    <form id="formAccountSettings" method="POST" action="{{ route('admin.data-approve.store') }}">
        @csrf
    ...
    @foreach ($getData as $ac)
        <form id="formAccountSettings" method="POST" action="{{ route('admin.data-approve.update', $ac->id ?? '') }}">
            @method('PUT')
            @csrf
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col mb-0">
                                    ...
                                    <input name="nama_pegawai" type="text" id="nama_pegawai" class="form-control"
                                        placeholder="Nama Pegawai" value="{{ $ac->pegawai->nama_pegawai ?? '' }}"
                                        readonly>
                                </div>
                                <div class="col mb-0">
